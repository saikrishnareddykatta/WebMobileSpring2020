...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //yourNameView = (EditText) findViewById(R.id.yourName);
        ...
        signup_button.setOnClickListener(new View.OnClickListener() {
           ...
           //     if (isEmpty(yourNameView)) {
           //         if (validationError) {
           //             validationErrorMessage.append(" and ");
           //         }
           //         validationError = true;
           //         validationErrorMessage.append("your Name");
           //     }if (isEmpty(courseView)) {
           //         if (validationError) {
           //             validationErrorMessage.append(" and ");
           //         }
           //         validationError = true;
           //         validationErrorMessage.append("your course");
           //     }
                else {
              ...
              //  user.setPassword(yourNameView.getText().toString());
                user.setEmail(courseView.getText().toString());
